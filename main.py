...
bounds1_D5 = np.array([[-5.12, 5.12]] * 5)
bounds2_D5 = np.array([[-2.048, 2.048]] * 5)
bounds3_D5 = np.array([[-500, 500]] * 5)

# Define bounds for the input variables
bounds1_D10 = np.array([[-5.12, 5.12]] * 10)
bounds2_D10 = np.array([[-2.048, 2.048]] * 10)
...
# Define max iterations -> ~cubic time increase
_max_iter = 50
...
rs_sa.plot_convergence(rs_sa.dejong1, bounds1_D5, "First Dejong Function - Random Search Algorithm - D5",
                    "1.RS_FirstDejongConvergenceD5", _max_iter, global_FD5, "random_search")
...
rs_sa.plot_convergence(rs_sa.dejong2, bounds2_D5, "Second Dejong Function - Random Search Algorithm - D5",
                    "2.RS_SecondDejongConvergenceD5", _max_iter, global_SD5, "random_search")
